select '0000' batch_no, tttt.*, get_json_string(tttt.check_voucher_result,'voucher_type_no') voucher_type_no , get_json_string(tttt.check_voucher_result,'check_result_no') check_result_no
